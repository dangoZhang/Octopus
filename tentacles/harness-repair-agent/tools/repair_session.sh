...
def normalized_outcome(item, origin):
    ...
    repair_queue_brief = item.get("repair_queue_brief") if isinstance(item.get("repair_queue_brief"), dict) else {}
    rollup_next = repair_effectiveness_rollup.get("next_need") if isinstance(repair_effectiveness_rollup.get("next_need"), dict) else {}
    queue_next = repair_queue_brief.get("next_need") if isinstance(repair_queue_brief.get("next_need"), dict) else {}
    return {
        "origin": origin,
        ...
        "repair_queue_brief_json": str(item.get("repair_queue_brief_json") or repair_queue_brief.get("json") or ""),
        "repair_queue_brief_status": str(item.get("repair_queue_brief_status") or repair_queue_brief.get("status") or ""),
        "repair_queue_brief_plan_status": str(item.get("repair_queue_brief_plan_status") or repair_queue_brief.get("plan_status") or ""),
        "repair_queue_brief_source": str(item.get("repair_queue_brief_source") or repair_queue_brief.get("source") or ""),
        "repair_queue_brief_blockers": compact_sequence(item.get("repair_queue_brief_blockers") or repair_queue_brief.get("blockers") or ""),
        "repair_queue_brief_review_first": str(item.get("repair_queue_brief_review_first") or repair_queue_brief.get("review_first") or ""),
        "repair_queue_brief_next_need_kind": str(item.get("repair_queue_brief_next_need_kind") or queue_next.get("kind") or ""),
        "repair_queue_brief_next_need_query": str(item.get("repair_queue_brief_next_need_query") or queue_next.get("query") or ""),
        ...
        "action_trace_repair_draft_strategy_status": str(item.get("action_trace_repair_draft_strategy_status") or action_draft_strategy.get("status") or ""),
        "action_trace_repair_draft_strategy_focus": str(item.get("action_trace_repair_draft_strategy_focus") or action_draft_strategy.get("focus") or ""),
        "action_trace_repair_draft_strategy_learned_reuse": str(item.get("action_trace_repair_draft_strategy_learned_reuse") or action_draft_strategy.get("learned_reuse") or ""),
        "action_trace_repair_draft_strategy_learned_avoid": str(item.get("action_trace_repair_draft_strategy_learned_avoid") or action_draft_strategy.get("learned_avoid") or ""),
        "action_trace_repair_draft_strategy_next_need_kind": str(item.get("action_trace_repair_draft_strategy_next_need_kind") or action_draft_strategy.get("next_need_kind") or ""),
        "action_trace_repair_draft_strategy_next_need_query": str(item.get("action_trace_repair_draft_strategy_next_need_query") or action_draft_strategy.get("next_need_query") or ""),
        "action_trace_repair_draft_strategy_effectiveness_used_count": str(item.get("action_trace_repair_draft_strategy_effectiveness_used_count") or action_draft_strategy_effectiveness.get("used_count") or ""),
        "action_trace_repair_draft_strategy_effectiveness_success_rate": str(item.get("action_trace_repair_draft_strategy_effectiveness_success_rate") or action_draft_strategy_effectiveness.get("success_rate") or ""),
        ...
        for item in items if isinstance(items, list) else []:
            ...
            if key in positions:
                ...
                for field in [
                    ...
                    "action_trace_repair_draft_strategy_status",
                    "action_trace_repair_draft_strategy_focus",
                    "action_trace_repair_draft_strategy_learned_reuse",
                    "action_trace_repair_draft_strategy_learned_avoid",
                    "action_trace_repair_draft_strategy_next_need_kind",
                    "action_trace_repair_draft_strategy_next_need_query",
                    "action_trace_repair_draft_strategy_effectiveness_used_count",
...
def outcome_memory_markdown(outcomes, workspace, outcomes_file, repair_recall=None):
    ...
    for item in outcomes[-8:]:
        ...
        queue_status = item.get("repair_queue_brief_status") or "none"
        queue_source = item.get("repair_queue_brief_source") or "none"
        queue_blockers = item.get("repair_queue_brief_blockers") or "none"
        queue_next = item.get("repair_queue_brief_next_need_query") or ""
        ...
        lines.extend(
            [
                ...
                f"  queue_brief_used: status=`{queue_status}` source=`{queue_source}` blockers=`{compact(queue_blockers, 160)}` next=`{compact(queue_next, 180)}`",
...
def build_repair_draft_strategy(draft, draft_effectiveness, strategy_effectiveness, target_tentacle, target_tool):
    ...
    strategy_learned_reuse = compact(strategy_effectiveness.get("top_reuse") or "", 260)
    strategy_learned_avoid = compact(strategy_effectiveness.get("top_avoid") or "", 260)
    ...
    elif strategy_used_count > 0 and strategy_failed_count > strategy_satisfied_count:
        status = "inspect_unreliable_repair_draft_strategy"
        focus = strategy_learned_avoid or learned_avoid or "repair draft strategy needs inspection"
        next_kind = "execute"
        next_query = "octopus repair . after unreliable repair draft strategy"
    elif strategy_used_count > 0 and strategy_partial_count > 0 and strategy_satisfied_count == 0:
        status = "tighten_partial_repair_draft_strategy"
        focus = strategy_learned_avoid or strategy_learned_reuse or "partial repair draft strategy needs tighter evidence"
        next_kind = "execute"
        next_query = "octopus repair . after partial repair draft strategy"
...
def build_repair_draft_strategy_effectiveness(outcomes):
    used = []
    hints = {}
    counts = {
        "satisfied": 0,
    ...
    for outcome in outcomes:
        strategy_status = str(outcome.get("action_trace_repair_draft_strategy_status") or "").strip()
        strategy_focus = outcome.get("action_trace_repair_draft_strategy_focus") or ""
        learned_reuse = outcome.get("action_trace_repair_draft_strategy_learned_reuse") or ""
        learned_avoid = outcome.get("action_trace_repair_draft_strategy_learned_avoid") or ""
        next_query = outcome.get("action_trace_repair_draft_strategy_next_need_query") or ""
...
def build_repair_patch_apply_effectiveness(outcomes):
    used = []
    hints = {}
    counts = {
        "satisfied": 0,
    ...
    applied_statuses = {"applied", "failed", "check_failed", "failed_to_start"}
    for outcome in outcomes:
        ...
        if apply_status not in applied_statuses and apply_applied != "true":
            continue
        apply_hint = compact(
            " | ".join(
                part
                for part in [
                    ...
                    outcome.get("action_trace_repair_patch_apply_target"),
        ...
        counts[status] += 1
        used.append(outcome)
        if apply_applied == "true" and apply_status == "applied" and status == "satisfied":
            direction = "reuse"
        elif status in {"partial", "failed"} or apply_status in {"failed", "check_failed", "failed_to_start"}:
            direction = "avoid"
        else:
            direction = "observe"
        add_effectiveness_hint(
...
def build_repair_patch_verify_effectiveness(outcomes):
    used = []
    hints = {}
    counts = {
        "satisfied": 0,
    ...
    verified_statuses = {"passed", "failed", "failed_to_start"}
    for outcome in outcomes:
        ...
        if verify_status not in verified_statuses and verify_passed != "true":
            continue
        verify_hint = compact(
            " | ".join(
                part
                for part in [
                    ...
                    outcome.get("action_trace_repair_patch_verify_command"),
        ...
        counts[status] += 1
        used.append(outcome)
        if verify_passed == "true" and verify_status == "passed" and status == "satisfied":
            direction = "reuse"
...
def build_repair_queue_brief_effectiveness(outcomes):
    used = []
    hints = {}
    counts = {
        "satisfied": 0,
    ...
    for outcome in outcomes:
        queue_status = str(outcome.get("repair_queue_brief_status") or "").strip()
        queue_source = str(outcome.get("repair_queue_brief_source") or "").strip()
        plan_status = str(outcome.get("repair_queue_brief_plan_status") or "").strip()
        blockers = str(outcome.get("repair_queue_brief_blockers") or "").strip()
        review_first = str(outcome.get("repair_queue_brief_review_first") or "").strip()
        next_query = str(outcome.get("repair_queue_brief_next_need_query") or "").strip()
        if not any([queue_status, queue_source, plan_status, blockers, review_first, next_query]):
            continue
        queue_hint = compact(
            " | ".join(
                part
                for part in [
                    f"status={queue_status}" if queue_status else "",
                    f"source={queue_source}" if queue_source else "",
                    f"plan_status={plan_status}" if plan_status else "",
                    f"blockers={blockers}" if blockers else "",
                    f"review_first={review_first}" if review_first else "",
                    next_query,
                ]
                if part
            ),
...
def build_repair_effectiveness_rollup(sources):
    rows = []
    for name, label, effectiveness in sources:
        ...
        rows.append(row)
    active = [row for row in rows if row["used_count"] > 0]
    used_count = sum(row["used_count"] for row in active)
    satisfied_count = sum(row["satisfied_count"] for row in active)
    partial_count = sum(row["partial_count"] for row in active)
    failed_count = sum(row["failed_count"] for row in active)
    strongest = max(
        active,
        key=lambda row: (
            row["satisfied_count"],
    ...
    weakest = max(
        active,
        key=lambda row: (
            row["failed_count"] + row["partial_count"],
            row["used_count"],
            row["source"],
        ),
        default={},
    ...
    if used_count == 0:
        status = "collect_outcomes"
        focus = "collect scored repair outcomes across harness sources"
        next_need = {
            "kind": "verify",
            "query": "collect scored repair outcomes for repair effectiveness rollup",
        }
    elif failed_count + partial_count > satisfied_count:
        status = "inspect_unreliable_sources"
        focus = weakest.get("top_avoid") or f"inspect {weakest.get('label', 'repair source')}"
        next_need = {
            "kind": "execute",
            "query": f"octopus repair . after unreliable repair effectiveness source {weakest.get('source', 'unknown')}",
        }
    else:
        status = "reuse_effective_sources"
        focus = strongest.get("top_reuse") or f"reuse {strongest.get('label', 'repair source')}"
        next_need = {
            "kind": "verify",
            "query": f"reuse repair effectiveness source {strongest.get('source', 'unknown')} before next harness repair",
        }
    return {
        "schema_version": "octopus-harness-repair-effectiveness-rollup-v1",
        "status": status,
        ...
        "success_rate": rate_label(satisfied_count, used_count),
        "partial_rate": rate_label(partial_count, used_count),
        "failure_rate": rate_label(failed_count, used_count),
        "strongest_source": strongest.get("source", ""),
        "weakest_source": weakest.get("source", ""),
        "top_reuse": strongest.get("top_reuse", ""),
        "top_avoid": weakest.get("top_avoid", ""),
        "sources": rows,
        "next_need": next_need,
        "context_boundary": "Clean brain sees Goal + Mem + Need + Feed. Effectiveness rollup stays inside the harness tentacle.",
    }
...
def repair_effectiveness_rollup_markdown(rollup, workspace, rollup_json):
    next_need = rollup.get("next_need") if isinstance(rollup.get("next_need"), dict) else {}
    lines = [
        "# Repair Effectiveness Rollup",
        "",
        "This file compresses local repair effectiveness sources into one heartbeat Feed.",
        "It is local tentacle evidence, not clean-brain context.",
        "",
        f"json: `{rel(rollup_json, workspace)}`",
        f"status: `{rollup.get('status')}`",
        f"focus: {compact(rollup.get('focus'), 320)}",
        f"source_count: `{rollup.get('source_count', 0)}`",
        f"active_source_count: `{rollup.get('active_source_count', 0)}`",
        f"used_count: `{rollup.get('used_count', 0)}`",
        f"satisfied_count: `{rollup.get('satisfied_count', 0)}`",
        f"partial_count: `{rollup.get('partial_count', 0)}`",
        f"failed_count: `{rollup.get('failed_count', 0)}`",
        f"success_rate: `{rollup.get('success_rate', '0.00')}`",
        f"failure_rate: `{rollup.get('failure_rate', '0.00')}`",
        f"strongest_source: `{rollup.get('strongest_source') or 'none'}`",
        f"weakest_source: `{rollup.get('weakest_source') or 'none'}`",
        f"next_need: `{next_need.get('kind') or 'verify'} {next_need.get('query') or ''}`",
        "",
        "## Sources",
        "",
    ]
    for source in rollup.get("sources", []):
        lines.append(
            f"- `{source.get('source')}` used=`{source.get('used_count')}` "
            f"satisfied=`{source.get('satisfied_count')}` partial=`{source.get('partial_count')}` "
            f"failed=`{source.get('failed_count')}` success_rate=`{source.get('success_rate')}`"
        )
        reuse = compact(source.get("top_reuse"), 220)
        avoid = compact(source.get("top_avoid"), 220)
        if reuse:
            lines.append(f"  reuse: {reuse}")
        if avoid:
            lines.append(f"  avoid: {avoid}")
    return "\n".join(lines) + "\n"


def repair_effectiveness_rollup_effectiveness_markdown(effectiveness, workspace, effectiveness_json):
    lines = [
        "# Repair Effectiveness Rollup Effectiveness",
        "",
        "This file measures whether prior repair effectiveness rollup guidance helped later reviewed outcomes.",
    ...
    if not effectiveness.get("hints"):
        lines.append("No reviewed repair outcome has used repair effectiveness rollup guidance yet.")
        return "\n".join(lines) + "\n"
    lines.extend(["## Hints", ""])
    for hint in effectiveness["hints"]:
        lines.extend(
            [
                ...
                f"  guidance: {compact(hint.get('hint'), 260)}",
...
def repair_queue_brief_effectiveness_markdown(effectiveness, workspace, effectiveness_json):
    lines = [
        "# Repair Queue Brief Effectiveness",
        "",
        "This file measures whether prior heartbeat repair queue choices helped later reviewed outcomes.",
        "It is local tentacle Feed evidence, not clean-brain context.",
        "",
        f"json: `{rel(effectiveness_json, workspace)}`",
        f"used_count: `{effectiveness.get('used_count', 0)}`",
    ...
    if not effectiveness.get("hints"):
        lines.append("No reviewed repair outcome has used a repair queue brief yet.")
        return "\n".join(lines) + "\n"
    lines.extend(["## Hints", ""])
    for hint in effectiveness["hints"]:
        lines.extend(
            [
                ...
                f"  queue: {compact(hint.get('hint'), 260)}",
                f"  latest: target=`{hint.get('latest_target') or 'unknown'}` candidate=`{hint.get('latest_candidate') or 'none'}`",
                f"  summary: {compact(hint.get('latest_summary'), 220) or 'none'}",
            ]
        )
...
def build_repair_queue_brief_adaptation(effectiveness):
    used = count_value(effectiveness.get("used_count"))
    satisfied = count_value(effectiveness.get("satisfied_count"))
    partial = count_value(effectiveness.get("partial_count"))
    failed = count_value(effectiveness.get("failed_count"))
    unreliable = failed + partial
    if used == 0:
        status = "collect_queue_brief_outcomes"
        focus = "score repair outcomes that used heartbeat repair queue briefs"
        next_need = {
            "kind": "verify",
            "query": "collect scored repair outcomes for repair queue brief choices",
        }
    elif unreliable > satisfied:
        status = "repair_queue_selection"
        focus = effectiveness.get("top_avoid") or "inspect unreliable heartbeat repair queue selection"
        next_need = {
            "kind": "execute",
            "query": "repair heartbeat repair queue source selection after failed outcomes",
        }
    else:
        status = "reuse_queue_selection"
        focus = effectiveness.get("top_reuse") or "reuse effective heartbeat repair queue selection"
        next_need = {
            "kind": "verify",
            "query": "reuse effective repair queue source before next harness repair",
        }
    return {
        "schema_version": "octopus-harness-repair-queue-brief-adaptation-v1",
        "status": status,
        "focus": compact(focus, 320),
        "queue_used_count": used,
        "queue_satisfied_count": satisfied,
        "queue_partial_count": partial,
        "queue_failed_count": failed,
        "queue_success_rate": effectiveness.get("success_rate") or "0.00",
        "queue_failure_rate": effectiveness.get("failure_rate") or "0.00",
        "top_reuse": effectiveness.get("top_reuse") or "",
        "top_avoid": effectiveness.get("top_avoid") or "",
        "next_need": next_need,
        "context_boundary": "Clean brain sees Goal + Mem + Need + Feed. Queue adaptation stays inside the harness tentacle.",
    }


def repair_queue_brief_adaptation_markdown(adaptation, workspace, adaptation_json):
    next_need = adaptation.get("next_need") if isinstance(adaptation.get("next_need"), dict) else {}
    lines = [
        "# Repair Queue Brief Adaptation",
        "",
        "This file turns heartbeat repair queue outcomes into the next queue-selection adaptation Feed.",
        "It is local tentacle evidence, not clean-brain context.",
        "",
        f"json: `{rel(adaptation_json, workspace)}`",
        f"status: `{adaptation.get('status')}`",
        f"focus: {compact(adaptation.get('focus'), 320)}",
        f"queue_used_count: `{adaptation.get('queue_used_count', 0)}`",
        f"queue_satisfied_count: `{adaptation.get('queue_satisfied_count', 0)}`",
        f"queue_partial_count: `{adaptation.get('queue_partial_count', 0)}`",
        f"queue_failed_count: `{adaptation.get('queue_failed_count', 0)}`",
        f"queue_success_rate: `{adaptation.get('queue_success_rate', '0.00')}`",
        f"queue_failure_rate: `{adaptation.get('queue_failure_rate', '0.00')}`",
        f"next_need: `{next_need.get('kind') or 'verify'} {next_need.get('query') or ''}`",
        "",
        "## Guidance",
        "",
...
def repair_draft_strategy_markdown(strategy, workspace, strategy_json):
    ...
    lines = [
        ...
        f"- strategy_effectiveness_used: `{evidence.get('strategy_used_count', 0)}`",
        f"- strategy_effectiveness_satisfied: `{evidence.get('strategy_satisfied_count', 0)}`",
        f"- strategy_effectiveness_partial: `{evidence.get('strategy_partial_count', 0)}`",
        f"- strategy_effectiveness_failed: `{evidence.get('strategy_failed_count', 0)}`",
        f"- strategy_effectiveness_success: `{evidence.get('strategy_success_rate', '0.00')}`",
...
def repair_draft_strategy_effectiveness_markdown(effectiveness, workspace, effectiveness_json):
    lines = [
        "# Harness Repair Draft Strategy Effectiveness",
        "",
        "This file measures whether prior repair draft strategies helped later reviewed outcomes.",
        "It is local tentacle Feed evidence, not clean-brain context.",
        "",
        f"json: `{rel(effectiveness_json, workspace)}`",
        f"used_count: `{effectiveness.get('used_count', 0)}`",
    ...
    if not effectiveness.get("hints"):
        lines.append("No scored repair outcome has used a repair draft strategy yet.")
        return "\n".join(lines) + "\n"
    lines.extend(["## Hints", ""])
    for hint in effectiveness["hints"]:
        lines.extend(
...
def repair_patch_apply_effectiveness_markdown(effectiveness, workspace, effectiveness_json):
    lines = [
        "# Harness Repair Patch Apply Effectiveness",
        "",
        "This file measures whether grant-bound provider patch application helped later reviewed outcomes.",
        "It is local tentacle Feed evidence, not clean-brain context.",
        "",
        f"json: `{rel(effectiveness_json, workspace)}`",
        f"used_count: `{effectiveness.get('used_count', 0)}`",
    ...
    if not effectiveness.get("hints"):
        lines.append("No scored repair outcome has applied a reviewed provider patch yet.")
        return "\n".join(lines) + "\n"
    lines.extend(["## Hints", ""])
    for hint in effectiveness["hints"]:
        lines.extend(
            [
                ...
                f"  apply: {compact(hint.get('hint'), 260)}",
                f"  latest: target=`{hint.get('latest_target') or 'unknown'}` candidate=`{hint.get('latest_candidate') or 'none'}`",
                f"  summary: {compact(hint.get('latest_summary'), 220) or 'none'}",
            ]
        )
...
def repair_patch_verify_effectiveness_markdown(effectiveness, workspace, effectiveness_json):
    lines = [
        "# Harness Repair Patch Verify Effectiveness",
        "",
        "This file measures whether post-apply patch verification helped later reviewed outcomes.",
        "It is local tentacle Feed evidence, not clean-brain context.",
        "",
        f"json: `{rel(effectiveness_json, workspace)}`",
        f"used_count: `{effectiveness.get('used_count', 0)}`",
    ...
    if not effectiveness.get("hints"):
        lines.append("No scored repair outcome has verified an applied provider patch yet.")
        return "\n".join(lines) + "\n"
    lines.extend(["## Hints", ""])
    for hint in effectiveness["hints"]:
        lines.extend(
            [
                ...
                f"  verify: {compact(hint.get('hint'), 260)}",
                f"  latest: target=`{hint.get('latest_target') or 'unknown'}` candidate=`{hint.get('latest_candidate') or 'none'}`",
                f"  summary: {compact(hint.get('latest_summary'), 220) or 'none'}",
            ]
        )
...
def action_trace_record(
    ...
    draft_strategy_summary = {
        ...
        "strategy_learned_reuse": compact(repair_draft_strategy.get("strategy_learned_reuse") or "", 240),
        "strategy_learned_avoid": compact(repair_draft_strategy.get("strategy_learned_avoid") or "", 240),
        "next_need_kind": str(draft_strategy_next.get("kind") or ""),
        "next_need_query": compact(draft_strategy_next.get("query") or "", 260),
    }
    draft_strategy_effectiveness_summary = {
        "used_count": str(repair_draft_strategy_effectiveness.get("used_count") or 0),
        "satisfied_count": str(repair_draft_strategy_effectiveness.get("satisfied_count") or 0),
        "failed_count": str(repair_draft_strategy_effectiveness.get("failed_count") or 0),
        "success_rate": str(repair_draft_strategy_effectiveness.get("success_rate") or "0.00"),
        "top_reuse": compact(repair_draft_strategy_effectiveness.get("top_reuse") or "", 240),
        "top_avoid": compact(repair_draft_strategy_effectiveness.get("top_avoid") or "", 240),
    }
    ...
    patch_apply_effectiveness_summary = {
        "used_count": str(repair_patch_apply_effectiveness.get("used_count") or 0),
        "satisfied_count": str(repair_patch_apply_effectiveness.get("satisfied_count") or 0),
        "failed_count": str(repair_patch_apply_effectiveness.get("failed_count") or 0),
        "success_rate": str(repair_patch_apply_effectiveness.get("success_rate") or "0.00"),
        "top_reuse": compact(repair_patch_apply_effectiveness.get("top_reuse") or "", 240),
        "top_avoid": compact(repair_patch_apply_effectiveness.get("top_avoid") or "", 240),
    }
    patch_verify_effectiveness_summary = {
        "used_count": str(repair_patch_verify_effectiveness.get("used_count") or 0),
        "satisfied_count": str(repair_patch_verify_effectiveness.get("satisfied_count") or 0),
        "failed_count": str(repair_patch_verify_effectiveness.get("failed_count") or 0),
        "success_rate": str(repair_patch_verify_effectiveness.get("success_rate") or "0.00"),
        "top_reuse": compact(repair_patch_verify_effectiveness.get("top_reuse") or "", 240),
        "top_avoid": compact(repair_patch_verify_effectiveness.get("top_avoid") or "", 240),
    }
    ...
    rollup_effectiveness_summary = {
        "used_count": str(repair_effectiveness_rollup_effectiveness.get("used_count") or 0),
        "satisfied_count": str(repair_effectiveness_rollup_effectiveness.get("satisfied_count") or 0),
        "failed_count": str(repair_effectiveness_rollup_effectiveness.get("failed_count") or 0),
        "success_rate": str(repair_effectiveness_rollup_effectiveness.get("success_rate") or "0.00"),
        "top_reuse": compact(repair_effectiveness_rollup_effectiveness.get("top_reuse") or "", 240),
        "top_avoid": compact(repair_effectiveness_rollup_effectiveness.get("top_avoid") or "", 240),
    }
    decision_next = repair_decision.get("next_need") if isinstance(repair_decision.get("next_need"), dict) else {}
    decision_summary = {
    ...
    stages = [
        ...
        },
        {
            ...
            "result": f"field={field_trajectory['field']} mini_task={field_trajectory['mini_task']} recalled={recall_count} top={recall_top_status} lessons={lessons_summary['lesson_count']} effectiveness_used={effectiveness_summary['used_count']} action_trace_effectiveness_used={action_trace_effectiveness_summary['used_count']} draft_effectiveness_used={draft_effectiveness_summary['used_count']} draft_strategy={draft_strategy_summary['status']} draft_strategy_effectiveness_used={draft_strategy_effectiveness_summary['used_count']} patch_draft={patch_draft_summary['status']} patch_draft_effectiveness_used={patch_draft_effectiveness_summary['used_count']} patch_review={patch_review_summary['status']} patch_review_effectiveness_used={patch_review_effectiveness_summary['used_count']} patch_apply_effectiveness_used={patch_apply_effectiveness_summary['used_count']} patch_verify_effectiveness_used={patch_verify_effectiveness_summary['used_count']} patch_learning={patch_learning_summary['status']} patch_learning_effectiveness_used={patch_learning_effectiveness_summary['used_count']} patch_strategy={patch_strategy_summary['status']} patch_strategy_effectiveness_used={patch_strategy_effectiveness_summary['used_count']} command_effectiveness_used={command_effectiveness_summary['used_count']} command_strategy={command_strategy_summary['status']} command_strategy_effectiveness_used={command_strategy_effectiveness_summary['used_count']} decision_effectiveness_used={decision_effectiveness_summary['used_count']} drift={drift_summary['status']} drift_effectiveness_used={drift_effectiveness_summary['used_count']} rollup_effectiveness_used={rollup_effectiveness_summary['used_count']} success_rate={effectiveness_summary['success_rate']} decision={decision_summary['decision']}",
            "status": "satisfied",
        },
        {
            "kind": "Action",
    ...
    return {
        ...
        "repair_draft_strategy_effectiveness": draft_strategy_effectiveness_summary,
        ...
        "repair_patch_apply_effectiveness": patch_apply_effectiveness_summary,
        "repair_patch_verify_effectiveness": patch_verify_effectiveness_summary,
        ...
        "repair_effectiveness_rollup_effectiveness": rollup_effectiveness_summary,
...
def action_trace_markdown(record, workspace, repair_plan):
    lines = [
        ...
        f"repair_draft_strategy_effectiveness_used: `{record.get('repair_draft_strategy_effectiveness', {}).get('used_count', '0')}`",
        f"repair_draft_strategy_effectiveness_success_rate: `{record.get('repair_draft_strategy_effectiveness', {}).get('success_rate', '0.00')}`",
        ...
        f"repair_patch_apply_effectiveness_used: `{record.get('repair_patch_apply_effectiveness', {}).get('used_count', '0')}`",
        f"repair_patch_apply_effectiveness_success_rate: `{record.get('repair_patch_apply_effectiveness', {}).get('success_rate', '0.00')}`",
        f"repair_patch_verify_effectiveness_used: `{record.get('repair_patch_verify_effectiveness', {}).get('used_count', '0')}`",
        f"repair_patch_verify_effectiveness_success_rate: `{record.get('repair_patch_verify_effectiveness', {}).get('success_rate', '0.00')}`",
        ...
        f"repair_effectiveness_rollup_effectiveness_used: `{record.get('repair_effectiveness_rollup_effectiveness', {}).get('used_count', '0')}`",
        f"repair_effectiveness_rollup_effectiveness_success_rate: `{record.get('repair_effectiveness_rollup_effectiveness', {}).get('success_rate', '0.00')}`",
...
repair_draft_strategy_effectiveness_json = session_dir / "REPAIR_DRAFT_STRATEGY_EFFECTIVENESS.json"
repair_draft_strategy_effectiveness_md = session_dir / "REPAIR_DRAFT_STRATEGY_EFFECTIVENESS.md"
...
repair_patch_apply_effectiveness_json = session_dir / "REPAIR_PATCH_APPLY_EFFECTIVENESS.json"
repair_patch_apply_effectiveness_md = session_dir / "REPAIR_PATCH_APPLY_EFFECTIVENESS.md"
repair_patch_verify_json = session_dir / "REPAIR_PATCH_VERIFY.json"
repair_patch_verify_md = session_dir / "REPAIR_PATCH_VERIFY.md"
repair_patch_verify_effectiveness_json = session_dir / "REPAIR_PATCH_VERIFY_EFFECTIVENESS.json"
repair_patch_verify_effectiveness_md = session_dir / "REPAIR_PATCH_VERIFY_EFFECTIVENESS.md"
...
repair_effectiveness_rollup_json = session_dir / "REPAIR_EFFECTIVENESS_ROLLUP.json"
...
repair_queue_brief_effectiveness_json = session_dir / "REPAIR_QUEUE_BRIEF_EFFECTIVENESS.json"
repair_queue_brief_effectiveness_md = session_dir / "REPAIR_QUEUE_BRIEF_EFFECTIVENESS.md"
repair_queue_brief_adaptation_json = session_dir / "REPAIR_QUEUE_BRIEF_ADAPTATION.json"
repair_queue_brief_adaptation_md = session_dir / "REPAIR_QUEUE_BRIEF_ADAPTATION.md"
...
repair_draft_strategy_effectiveness = build_repair_draft_strategy_effectiveness(repair_outcomes)
...
repair_patch_apply_effectiveness = build_repair_patch_apply_effectiveness(repair_outcomes)
repair_patch_verify_effectiveness = build_repair_patch_verify_effectiveness(repair_outcomes)
...
repair_queue_brief_effectiveness = build_repair_queue_brief_effectiveness(repair_outcomes)
repair_queue_brief_adaptation = build_repair_queue_brief_adaptation(repair_queue_brief_effectiveness)
repair_effectiveness_rollup = build_repair_effectiveness_rollup([
    ...
    ("repair_draft", "repair draft", repair_draft_effectiveness),
    ("repair_draft_strategy", "repair draft strategy", repair_draft_strategy_effectiveness),
    ("repair_patch_draft", "repair patch draft", repair_patch_draft_effectiveness),
    ("repair_patch_review", "repair patch review", repair_patch_review_effectiveness),
    ("repair_patch_apply", "repair patch apply", repair_patch_apply_effectiveness),
    ("repair_patch_verify", "repair patch verify", repair_patch_verify_effectiveness),
    ("repair_patch_learning", "repair patch learning", repair_patch_learning_effectiveness),
    ("repair_patch_strategy", "repair patch strategy", repair_patch_strategy_effectiveness),
    ("repair_command", "repair command", repair_command_effectiveness),
    ("repair_command_strategy", "repair command strategy", repair_command_strategy_effectiveness),
    ...
    ("repair_queue_brief", "repair queue brief", repair_queue_brief_effectiveness),
])
...
session = {
    ...
    "repair_draft_strategy_effectiveness": rel(repair_draft_strategy_effectiveness_md, workspace),
    "repair_draft_strategy_effectiveness_json": rel(repair_draft_strategy_effectiveness_json, workspace),
    ...
    "repair_patch_apply_effectiveness": rel(repair_patch_apply_effectiveness_md, workspace),
    "repair_patch_apply_effectiveness_json": rel(repair_patch_apply_effectiveness_json, workspace),
    "repair_patch_verify": rel(repair_patch_verify_md, workspace),
    "repair_patch_verify_json": rel(repair_patch_verify_json, workspace),
    "repair_patch_verify_effectiveness": rel(repair_patch_verify_effectiveness_md, workspace),
    "repair_patch_verify_effectiveness_json": rel(repair_patch_verify_effectiveness_json, workspace),
    ...
    "repair_effectiveness_rollup": rel(repair_effectiveness_rollup_md, workspace),
    ...
    "repair_queue_brief_effectiveness": rel(repair_queue_brief_effectiveness_md, workspace),
    "repair_queue_brief_effectiveness_json": rel(repair_queue_brief_effectiveness_json, workspace),
    "repair_queue_brief_adaptation": rel(repair_queue_brief_adaptation_md, workspace),
    "repair_queue_brief_adaptation_json": rel(repair_queue_brief_adaptation_json, workspace),
    ...
    "repair_draft_strategy_effectiveness_summary": {
        "used_count": repair_draft_strategy_effectiveness["used_count"],
        "satisfied_count": repair_draft_strategy_effectiveness["satisfied_count"],
        "failed_count": repair_draft_strategy_effectiveness["failed_count"],
        "success_rate": repair_draft_strategy_effectiveness["success_rate"],
        "top_reuse": repair_draft_strategy_effectiveness["top_reuse"],
        "top_avoid": repair_draft_strategy_effectiveness["top_avoid"],
    },
    ...
    "repair_patch_apply_effectiveness_summary": {
        "used_count": repair_patch_apply_effectiveness["used_count"],
        "satisfied_count": repair_patch_apply_effectiveness["satisfied_count"],
        "failed_count": repair_patch_apply_effectiveness["failed_count"],
        "success_rate": repair_patch_apply_effectiveness["success_rate"],
        "top_reuse": repair_patch_apply_effectiveness["top_reuse"],
        "top_avoid": repair_patch_apply_effectiveness["top_avoid"],
    },
    "repair_patch_verify_effectiveness_summary": {
        "used_count": repair_patch_verify_effectiveness["used_count"],
        "satisfied_count": repair_patch_verify_effectiveness["satisfied_count"],
        "failed_count": repair_patch_verify_effectiveness["failed_count"],
        "success_rate": repair_patch_verify_effectiveness["success_rate"],
        "top_reuse": repair_patch_verify_effectiveness["top_reuse"],
        "top_avoid": repair_patch_verify_effectiveness["top_avoid"],
    },
    ...
    "repair_effectiveness_rollup_summary": {
        "status": repair_effectiveness_rollup["status"],
        "source_count": repair_effectiveness_rollup["source_count"],
        "active_source_count": repair_effectiveness_rollup["active_source_count"],
        "used_count": repair_effectiveness_rollup["used_count"],
        "satisfied_count": repair_effectiveness_rollup["satisfied_count"],
        "failed_count": repair_effectiveness_rollup["failed_count"],
        "success_rate": repair_effectiveness_rollup["success_rate"],
        "strongest_source": repair_effectiveness_rollup["strongest_source"],
        "weakest_source": repair_effectiveness_rollup["weakest_source"],
        "next_need": repair_effectiveness_rollup["next_need"],
    },
    "repair_effectiveness_rollup_effectiveness_summary": {
        "used_count": repair_effectiveness_rollup_effectiveness["used_count"],
        "satisfied_count": repair_effectiveness_rollup_effectiveness["satisfied_count"],
        "failed_count": repair_effectiveness_rollup_effectiveness["failed_count"],
    ...
    "repair_queue_brief_effectiveness_summary": {
        "used_count": repair_queue_brief_effectiveness["used_count"],
        "satisfied_count": repair_queue_brief_effectiveness["satisfied_count"],
        "failed_count": repair_queue_brief_effectiveness["failed_count"],
        "success_rate": repair_queue_brief_effectiveness["success_rate"],
        "top_reuse": repair_queue_brief_effectiveness["top_reuse"],
        "top_avoid": repair_queue_brief_effectiveness["top_avoid"],
    },
    "repair_queue_brief_adaptation_summary": {
        "status": repair_queue_brief_adaptation["status"],
        "focus": repair_queue_brief_adaptation["focus"],
        "queue_used_count": repair_queue_brief_adaptation["queue_used_count"],
        "queue_satisfied_count": repair_queue_brief_adaptation["queue_satisfied_count"],
        "queue_failed_count": repair_queue_brief_adaptation["queue_failed_count"],
        "queue_success_rate": repair_queue_brief_adaptation["queue_success_rate"],
        "next_need": repair_queue_brief_adaptation["next_need"],
    },
...
repair_draft_strategy_effectiveness_json.write_text(
    json.dumps(repair_draft_strategy_effectiveness, ensure_ascii=True, indent=2) + "\n",
    encoding="utf-8",
)
repair_draft_strategy_effectiveness_md.write_text(
    repair_draft_strategy_effectiveness_markdown(
        repair_draft_strategy_effectiveness,
        workspace,
...
repair_patch_apply_effectiveness_json.write_text(
    json.dumps(repair_patch_apply_effectiveness, ensure_ascii=True, indent=2) + "\n",
    encoding="utf-8",
)
repair_patch_apply_effectiveness_md.write_text(
    repair_patch_apply_effectiveness_markdown(
        repair_patch_apply_effectiveness,
        workspace,
...
repair_patch_verify_effectiveness_json.write_text(
    json.dumps(repair_patch_verify_effectiveness, ensure_ascii=True, indent=2) + "\n",
    encoding="utf-8",
)
repair_patch_verify_effectiveness_md.write_text(
    repair_patch_verify_effectiveness_markdown(
        repair_patch_verify_effectiveness,
        workspace,
...
repair_effectiveness_rollup_json.write_text(
    json.dumps(repair_effectiveness_rollup, ensure_ascii=True, indent=2) + "\n",
    encoding="utf-8",
)
repair_effectiveness_rollup_md.write_text(
    repair_effectiveness_rollup_markdown(
        repair_effectiveness_rollup,
        workspace,
        repair_effectiveness_rollup_json,
    ),
...
repair_effectiveness_rollup_effectiveness_json.write_text(
    json.dumps(repair_effectiveness_rollup_effectiveness, ensure_ascii=True, indent=2) + "\n",
    encoding="utf-8",
)
repair_effectiveness_rollup_effectiveness_md.write_text(
    repair_effectiveness_rollup_effectiveness_markdown(
        repair_effectiveness_rollup_effectiveness,
        workspace,
...
repair_queue_brief_effectiveness_json.write_text(
    json.dumps(repair_queue_brief_effectiveness, ensure_ascii=True, indent=2) + "\n",
    encoding="utf-8",
)
repair_queue_brief_effectiveness_md.write_text(
    repair_queue_brief_effectiveness_markdown(
...
repair_queue_brief_adaptation_json.write_text(
    json.dumps(repair_queue_brief_adaptation, ensure_ascii=True, indent=2) + "\n",
    encoding="utf-8",
)
repair_queue_brief_adaptation_md.write_text(
    repair_queue_brief_adaptation_markdown(
...
repair_plan["inputs"]["repair_draft_strategy_effectiveness"] = rel(repair_draft_strategy_effectiveness_md, workspace)
repair_plan["inputs"]["repair_draft_strategy_effectiveness_json"] = rel(repair_draft_strategy_effectiveness_json, workspace)
...
repair_plan["inputs"]["repair_patch_apply_effectiveness"] = rel(repair_patch_apply_effectiveness_md, workspace)
repair_plan["inputs"]["repair_patch_apply_effectiveness_json"] = rel(repair_patch_apply_effectiveness_json, workspace)
...
repair_plan["inputs"]["repair_patch_verify_effectiveness"] = rel(repair_patch_verify_effectiveness_md, workspace)
repair_plan["inputs"]["repair_patch_verify_effectiveness_json"] = rel(repair_patch_verify_effectiveness_json, workspace)
...
repair_plan["inputs"]["repair_effectiveness_rollup"] = rel(repair_effectiveness_rollup_md, workspace)
...
repair_plan["inputs"]["repair_queue_brief_effectiveness"] = rel(repair_queue_brief_effectiveness_md, workspace)
repair_plan["inputs"]["repair_queue_brief_effectiveness_json"] = rel(repair_queue_brief_effectiveness_json, workspace)
repair_plan["inputs"]["repair_queue_brief_adaptation"] = rel(repair_queue_brief_adaptation_md, workspace)
repair_plan["inputs"]["repair_queue_brief_adaptation_json"] = rel(repair_queue_brief_adaptation_json, workspace)
...
repair_plan["repair_patch_apply_effectiveness_summary"] = session["repair_patch_apply_effectiveness_summary"]
repair_plan["repair_patch_verify_effectiveness_summary"] = session["repair_patch_verify_effectiveness_summary"]
...
draft_strategy_effectiveness_lines = [
    (
        f"- {hint.get('direction')}"
        f" used={hint.get('used_count')}"
        f" satisfied={hint.get('satisfied_count')}"
    ...
    for hint in repair_draft_strategy_effectiveness.get("hints", [])[:4]
] or ["- none"]
...
patch_apply_effectiveness_lines = [
    (
        f"- {hint.get('direction')}"
        f" used={hint.get('used_count')}"
        f" satisfied={hint.get('satisfied_count')}"
        f" failed={hint.get('failed_count')}"
        f" success={hint.get('success_rate')}"
        f" apply={compact(hint.get('hint') or '', 180)}"
    )
    for hint in repair_patch_apply_effectiveness.get("hints", [])[:4]
] or ["- none"]
patch_verify_effectiveness_lines = [
    (
        f"- {hint.get('direction')}"
        f" used={hint.get('used_count')}"
        f" satisfied={hint.get('satisfied_count')}"
        f" failed={hint.get('failed_count')}"
        f" success={hint.get('success_rate')}"
        f" verify={compact(hint.get('hint') or '', 180)}"
    )
    for hint in repair_patch_verify_effectiveness.get("hints", [])[:4]
] or ["- none"]
...
prompt_md.write_text(
    "\n".join(
        [
            ...
            *draft_effectiveness_lines,
            "",
            "repair draft strategy effectiveness:",
            f"- effectiveness artifact: `{rel(repair_draft_strategy_effectiveness_md, workspace)}`",
            f"- effectiveness json: `{rel(repair_draft_strategy_effectiveness_json, workspace)}`",
            f"- used: `{repair_draft_strategy_effectiveness.get('used_count', 0)}` satisfied: `{repair_draft_strategy_effectiveness.get('satisfied_count', 0)}` failed: `{repair_draft_strategy_effectiveness.get('failed_count', 0)}` success_rate: `{repair_draft_strategy_effectiveness.get('success_rate', '0.00')}`",
            *draft_strategy_effectiveness_lines,
            "",
            ...
            *patch_review_effectiveness_lines,
            "",
            "repair patch apply effectiveness:",
            f"- effectiveness artifact: `{rel(repair_patch_apply_effectiveness_md, workspace)}`",
            f"- effectiveness json: `{rel(repair_patch_apply_effectiveness_json, workspace)}`",
            f"- used: `{repair_patch_apply_effectiveness.get('used_count', 0)}` satisfied: `{repair_patch_apply_effectiveness.get('satisfied_count', 0)}` failed: `{repair_patch_apply_effectiveness.get('failed_count', 0)}` success_rate: `{repair_patch_apply_effectiveness.get('success_rate', '0.00')}`",
            *patch_apply_effectiveness_lines,
            "",
            "repair patch verify effectiveness:",
            f"- effectiveness artifact: `{rel(repair_patch_verify_effectiveness_md, workspace)}`",
            f"- effectiveness json: `{rel(repair_patch_verify_effectiveness_json, workspace)}`",
            f"- used: `{repair_patch_verify_effectiveness.get('used_count', 0)}` satisfied: `{repair_patch_verify_effectiveness.get('satisfied_count', 0)}` failed: `{repair_patch_verify_effectiveness.get('failed_count', 0)}` success_rate: `{repair_patch_verify_effectiveness.get('success_rate', '0.00')}`",
            *patch_verify_effectiveness_lines,
            "",
            ...
            *drift_effectiveness_lines,
            "",
            "repair effectiveness rollup:",
            f"- rollup artifact: `{rel(repair_effectiveness_rollup_md, workspace)}`",
            f"- rollup json: `{rel(repair_effectiveness_rollup_json, workspace)}`",
            f"- status: `{repair_effectiveness_rollup.get('status')}` active_sources: `{repair_effectiveness_rollup.get('active_source_count', 0)}` used: `{repair_effectiveness_rollup.get('used_count', 0)}` success_rate: `{repair_effectiveness_rollup.get('success_rate', '0.00')}`",
            f"- strongest_source: `{repair_effectiveness_rollup.get('strongest_source') or 'none'}` weakest_source: `{repair_effectiveness_rollup.get('weakest_source') or 'none'}`",
            "",
            "repair effectiveness rollup effectiveness:",
            f"- effectiveness artifact: `{rel(repair_effectiveness_rollup_effectiveness_md, workspace)}`",
            ...
            "",
            "repair queue brief effectiveness:",
            f"- queue effectiveness artifact: `{rel(repair_queue_brief_effectiveness_md, workspace)}`",
            f"- queue effectiveness json: `{rel(repair_queue_brief_effectiveness_json, workspace)}`",
            f"- used: `{repair_queue_brief_effectiveness.get('used_count', 0)}` satisfied: `{repair_queue_brief_effectiveness.get('satisfied_count', 0)}` failed: `{repair_queue_brief_effectiveness.get('failed_count', 0)}` success_rate: `{repair_queue_brief_effectiveness.get('success_rate', '0.00')}`",
            "",
            "repair queue brief adaptation:",
            f"- adaptation artifact: `{rel(repair_queue_brief_adaptation_md, workspace)}`",
            f"- adaptation json: `{rel(repair_queue_brief_adaptation_json, workspace)}`",
            f"- status: `{repair_queue_brief_adaptation.get('status')}` queue_used: `{repair_queue_brief_adaptation.get('queue_used_count', 0)}` queue_success_rate: `{repair_queue_brief_adaptation.get('queue_success_rate', '0.00')}`",
            "",
            "repair decision:",
            ...
            f"- repair draft strategy effectiveness: `{rel(repair_draft_strategy_effectiveness_md, workspace)}`",
            f"- repair draft strategy effectiveness json: `{rel(repair_draft_strategy_effectiveness_json, workspace)}`",
            ...
            f"- repair patch apply effectiveness: `{rel(repair_patch_apply_effectiveness_md, workspace)}`",
            f"- repair patch apply effectiveness json: `{rel(repair_patch_apply_effectiveness_json, workspace)}`",
            ...
            f"- repair patch verify effectiveness: `{rel(repair_patch_verify_effectiveness_md, workspace)}`",
            f"- repair patch verify effectiveness json: `{rel(repair_patch_verify_effectiveness_json, workspace)}`",
            ...
            f"- repair effectiveness rollup: `{rel(repair_effectiveness_rollup_md, workspace)}`",
            ...
            f"- repair queue brief effectiveness: `{rel(repair_queue_brief_effectiveness_md, workspace)}`",
            f"- repair queue brief effectiveness json: `{rel(repair_queue_brief_effectiveness_json, workspace)}`",
            f"- repair queue brief adaptation: `{rel(repair_queue_brief_adaptation_md, workspace)}`",
            f"- repair queue brief adaptation json: `{rel(repair_queue_brief_adaptation_json, workspace)}`",
...
session["repair_draft_strategy_summary"] = {
    ...
    "strategy_learned_reuse": repair_draft_strategy["strategy_learned_reuse"],
    "strategy_learned_avoid": repair_draft_strategy["strategy_learned_avoid"],
...
session["repair_patch_apply_effectiveness_summary"] = {
    "used_count": repair_patch_apply_effectiveness["used_count"],
    "satisfied_count": repair_patch_apply_effectiveness["satisfied_count"],
    "failed_count": repair_patch_apply_effectiveness["failed_count"],
    "success_rate": repair_patch_apply_effectiveness["success_rate"],
...
session["repair_patch_verify_effectiveness_summary"] = {
    "used_count": repair_patch_verify_effectiveness["used_count"],
    "satisfied_count": repair_patch_verify_effectiveness["satisfied_count"],
    "failed_count": repair_patch_verify_effectiveness["failed_count"],
    "success_rate": repair_patch_verify_effectiveness["success_rate"],
...
repair_plan["repair_draft_strategy_effectiveness_summary"] = session["repair_draft_strategy_effectiveness_summary"]
...
metadata = {
    ...
    "repair_draft_strategy_strategy_learned_reuse": repair_draft_strategy.get("strategy_learned_reuse", ""),
    "repair_draft_strategy_strategy_learned_avoid": repair_draft_strategy.get("strategy_learned_avoid", ""),
    ...
    "repair_draft_strategy_effectiveness": rel(repair_draft_strategy_effectiveness_md, workspace),
    "repair_draft_strategy_effectiveness_json": rel(repair_draft_strategy_effectiveness_json, workspace),
    "repair_draft_strategy_effectiveness_used_count": str(repair_draft_strategy_effectiveness.get("used_count", 0)),
    "repair_draft_strategy_effectiveness_satisfied_count": str(repair_draft_strategy_effectiveness.get("satisfied_count", 0)),
    "repair_draft_strategy_effectiveness_partial_count": str(repair_draft_strategy_effectiveness.get("partial_count", 0)),
    "repair_draft_strategy_effectiveness_failed_count": str(repair_draft_strategy_effectiveness.get("failed_count", 0)),
    "repair_draft_strategy_effectiveness_success_rate": repair_draft_strategy_effectiveness.get("success_rate", "0.00"),
    "repair_draft_strategy_effectiveness_failure_rate": repair_draft_strategy_effectiveness.get("failure_rate", "0.00"),
    "repair_draft_strategy_effectiveness_top_reuse": repair_draft_strategy_effectiveness.get("top_reuse", ""),
    "repair_draft_strategy_effectiveness_top_avoid": repair_draft_strategy_effectiveness.get("top_avoid", ""),
    "repair_patch_draft": rel(repair_patch_draft_md, workspace),
    "repair_patch_draft_json": rel(repair_patch_draft_json, workspace),
    ...
    "repair_patch_apply_effectiveness": rel(repair_patch_apply_effectiveness_md, workspace),
    "repair_patch_apply_effectiveness_json": rel(repair_patch_apply_effectiveness_json, workspace),
    "repair_patch_apply_effectiveness_used_count": str(repair_patch_apply_effectiveness.get("used_count", 0)),
    "repair_patch_apply_effectiveness_satisfied_count": str(repair_patch_apply_effectiveness.get("satisfied_count", 0)),
    "repair_patch_apply_effectiveness_partial_count": str(repair_patch_apply_effectiveness.get("partial_count", 0)),
    "repair_patch_apply_effectiveness_failed_count": str(repair_patch_apply_effectiveness.get("failed_count", 0)),
    "repair_patch_apply_effectiveness_success_rate": repair_patch_apply_effectiveness.get("success_rate", "0.00"),
    "repair_patch_apply_effectiveness_failure_rate": repair_patch_apply_effectiveness.get("failure_rate", "0.00"),
    "repair_patch_apply_effectiveness_top_reuse": repair_patch_apply_effectiveness.get("top_reuse", ""),
    "repair_patch_apply_effectiveness_top_avoid": repair_patch_apply_effectiveness.get("top_avoid", ""),
    "repair_patch_verify": rel(repair_patch_verify_md, workspace),
    "repair_patch_verify_json": rel(repair_patch_verify_json, workspace),
    ...
    "repair_patch_verify_effectiveness": rel(repair_patch_verify_effectiveness_md, workspace),
    "repair_patch_verify_effectiveness_json": rel(repair_patch_verify_effectiveness_json, workspace),
    "repair_patch_verify_effectiveness_used_count": str(repair_patch_verify_effectiveness.get("used_count", 0)),
    "repair_patch_verify_effectiveness_satisfied_count": str(repair_patch_verify_effectiveness.get("satisfied_count", 0)),
    "repair_patch_verify_effectiveness_partial_count": str(repair_patch_verify_effectiveness.get("partial_count", 0)),
    "repair_patch_verify_effectiveness_failed_count": str(repair_patch_verify_effectiveness.get("failed_count", 0)),
    "repair_patch_verify_effectiveness_success_rate": repair_patch_verify_effectiveness.get("success_rate", "0.00"),
    "repair_patch_verify_effectiveness_failure_rate": repair_patch_verify_effectiveness.get("failure_rate", "0.00"),
    "repair_patch_verify_effectiveness_top_reuse": repair_patch_verify_effectiveness.get("top_reuse", ""),
    "repair_patch_verify_effectiveness_top_avoid": repair_patch_verify_effectiveness.get("top_avoid", ""),
    "repair_patch_learning": rel(repair_patch_learning_md, workspace),
    "repair_patch_learning_json": rel(repair_patch_learning_json, workspace),
    ...
    "repair_effectiveness_rollup": rel(repair_effectiveness_rollup_md, workspace),
    "repair_effectiveness_rollup_json": rel(repair_effectiveness_rollup_json, workspace),
    "repair_effectiveness_rollup_status": repair_effectiveness_rollup.get("status", ""),
    "repair_effectiveness_rollup_source_count": str(repair_effectiveness_rollup.get("source_count", 0)),
    "repair_effectiveness_rollup_active_source_count": str(repair_effectiveness_rollup.get("active_source_count", 0)),
    "repair_effectiveness_rollup_used_count": str(repair_effectiveness_rollup.get("used_count", 0)),
    "repair_effectiveness_rollup_satisfied_count": str(repair_effectiveness_rollup.get("satisfied_count", 0)),
    "repair_effectiveness_rollup_partial_count": str(repair_effectiveness_rollup.get("partial_count", 0)),
    "repair_effectiveness_rollup_failed_count": str(repair_effectiveness_rollup.get("failed_count", 0)),
    "repair_effectiveness_rollup_success_rate": repair_effectiveness_rollup.get("success_rate", "0.00"),
    "repair_effectiveness_rollup_failure_rate": repair_effectiveness_rollup.get("failure_rate", "0.00"),
    "repair_effectiveness_rollup_strongest_source": repair_effectiveness_rollup.get("strongest_source", ""),
    "repair_effectiveness_rollup_weakest_source": repair_effectiveness_rollup.get("weakest_source", ""),
    "repair_effectiveness_rollup_top_reuse": repair_effectiveness_rollup.get("top_reuse", ""),
    "repair_effectiveness_rollup_top_avoid": repair_effectiveness_rollup.get("top_avoid", ""),
    "repair_effectiveness_rollup_next_need_kind": repair_effectiveness_rollup.get("next_need", {}).get("kind", ""),
    "repair_effectiveness_rollup_next_need_query": repair_effectiveness_rollup.get("next_need", {}).get("query", ""),
    "repair_effectiveness_rollup_effectiveness": rel(repair_effectiveness_rollup_effectiveness_md, workspace),
    "repair_effectiveness_rollup_effectiveness_json": rel(repair_effectiveness_rollup_effectiveness_json, workspace),
    "repair_effectiveness_rollup_effectiveness_used_count": str(repair_effectiveness_rollup_effectiveness.get("used_count", 0)),
    "repair_effectiveness_rollup_effectiveness_satisfied_count": str(repair_effectiveness_rollup_effectiveness.get("satisfied_count", 0)),
    "repair_effectiveness_rollup_effectiveness_partial_count": str(repair_effectiveness_rollup_effectiveness.get("partial_count", 0)),
    "repair_effectiveness_rollup_effectiveness_failed_count": str(repair_effectiveness_rollup_effectiveness.get("failed_count", 0)),
    "repair_effectiveness_rollup_effectiveness_success_rate": repair_effectiveness_rollup_effectiveness.get("success_rate", "0.00"),
    ...
    "repair_queue_brief_effectiveness": rel(repair_queue_brief_effectiveness_md, workspace),
    "repair_queue_brief_effectiveness_json": rel(repair_queue_brief_effectiveness_json, workspace),
    "repair_queue_brief_effectiveness_used_count": str(repair_queue_brief_effectiveness.get("used_count", 0)),
    "repair_queue_brief_effectiveness_satisfied_count": str(repair_queue_brief_effectiveness.get("satisfied_count", 0)),
    "repair_queue_brief_effectiveness_partial_count": str(repair_queue_brief_effectiveness.get("partial_count", 0)),
    "repair_queue_brief_effectiveness_failed_count": str(repair_queue_brief_effectiveness.get("failed_count", 0)),
    "repair_queue_brief_effectiveness_success_rate": repair_queue_brief_effectiveness.get("success_rate", "0.00"),
    "repair_queue_brief_effectiveness_failure_rate": repair_queue_brief_effectiveness.get("failure_rate", "0.00"),
    "repair_queue_brief_effectiveness_top_reuse": repair_queue_brief_effectiveness.get("top_reuse", ""),
    "repair_queue_brief_effectiveness_top_avoid": repair_queue_brief_effectiveness.get("top_avoid", ""),
    "repair_queue_brief_adaptation": rel(repair_queue_brief_adaptation_md, workspace),
    "repair_queue_brief_adaptation_json": rel(repair_queue_brief_adaptation_json, workspace),
    "repair_queue_brief_adaptation_status": repair_queue_brief_adaptation.get("status", ""),
    "repair_queue_brief_adaptation_focus": repair_queue_brief_adaptation.get("focus", ""),
    "repair_queue_brief_adaptation_queue_used_count": str(repair_queue_brief_adaptation.get("queue_used_count", 0)),
    "repair_queue_brief_adaptation_queue_satisfied_count": str(repair_queue_brief_adaptation.get("queue_satisfied_count", 0)),
    "repair_queue_brief_adaptation_queue_partial_count": str(repair_queue_brief_adaptation.get("queue_partial_count", 0)),
    "repair_queue_brief_adaptation_queue_failed_count": str(repair_queue_brief_adaptation.get("queue_failed_count", 0)),
    "repair_queue_brief_adaptation_queue_success_rate": repair_queue_brief_adaptation.get("queue_success_rate", "0.00"),
    "repair_queue_brief_adaptation_queue_failure_rate": repair_queue_brief_adaptation.get("queue_failure_rate", "0.00"),
    "repair_queue_brief_adaptation_next_need_kind": repair_queue_brief_adaptation.get("next_need", {}).get("kind", ""),
    "repair_queue_brief_adaptation_next_need_query": repair_queue_brief_adaptation.get("next_need", {}).get("query", ""),
    "environment_profile_journal": rel(environment_profile_journal, workspace),
    "harness_adaptation": rel(harness_adaptation_md, workspace),
    "harness_adaptation_json": rel(harness_adaptation_json, workspace),
    ...
    "action_trace_repair_patch_apply_effectiveness_used_count": action_trace["repair_patch_apply_effectiveness"]["used_count"],
    "action_trace_repair_patch_apply_effectiveness_success_rate": action_trace["repair_patch_apply_effectiveness"]["success_rate"],
    "action_trace_repair_patch_verify_effectiveness_used_count": action_trace["repair_patch_verify_effectiveness"]["used_count"],
    "action_trace_repair_patch_verify_effectiveness_success_rate": action_trace["repair_patch_verify_effectiveness"]["success_rate"],
    ...
    "action_trace_repair_draft_strategy_learned_reuse": action_trace["repair_draft_strategy"]["learned_reuse"],
    "action_trace_repair_draft_strategy_learned_avoid": action_trace["repair_draft_strategy"]["learned_avoid"],
    ...
    "action_trace_repair_draft_strategy_effectiveness_used_count": action_trace["repair_draft_strategy_effectiveness"]["used_count"],
    "action_trace_repair_draft_strategy_effectiveness_success_rate": action_trace["repair_draft_strategy_effectiveness"]["success_rate"],
