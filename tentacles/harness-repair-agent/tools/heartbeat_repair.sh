...
def repair_draft_strategy_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_draft_strategy": rel(path, root) if path else "",
        "repair_draft_strategy_json": rel(json_path, root) if json_path else "",
        "repair_draft_strategy_status": "",
        "repair_draft_strategy_focus": "",
        ...
        "repair_draft_strategy_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        next_need = data.get("next_need") if isinstance(data.get("next_need"), dict) else {}
        metadata.update({
            "repair_draft_strategy_status": str(data.get("status") or ""),
            "repair_draft_strategy_focus": compact(data.get("focus") or "", 320),
            "repair_draft_strategy_learned_reuse": compact(data.get("learned_reuse") or "", 320),
            "repair_draft_strategy_learned_avoid": compact(data.get("learned_avoid") or "", 320),
            "repair_draft_strategy_strategy_learned_reuse": compact(data.get("strategy_learned_reuse") or "", 320),
            "repair_draft_strategy_strategy_learned_avoid": compact(data.get("strategy_learned_avoid") or "", 320),
            "repair_draft_strategy_next_need_kind": str(next_need.get("kind") or ""),
            "repair_draft_strategy_next_need_query": compact(next_need.get("query") or "", 320),
            "repair_draft_strategy_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_draft_strategy_preview"]:
        metadata["repair_draft_strategy_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_draft_strategy_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_draft_strategy_effectiveness": rel(path, root) if path else "",
        "repair_draft_strategy_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_draft_strategy_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_draft_strategy_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_draft_strategy_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_draft_strategy_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_draft_strategy_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_draft_strategy_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_draft_strategy_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_draft_strategy_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_draft_strategy_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_draft_strategy_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_draft_strategy_effectiveness_preview"]:
        metadata["repair_draft_strategy_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_patch_draft_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_patch_draft": rel(path, root) if path else "",
        "repair_patch_draft_json": rel(json_path, root) if json_path else "",
        "repair_patch_draft_status": "",
        "repair_patch_draft_draft_status": "",
        "repair_patch_draft_has_patch": "",
        "repair_patch_draft_target": "",
        "repair_patch_draft_next_need_kind": "",
        "repair_patch_draft_next_need_query": "",
        "repair_patch_draft_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        ...
        metadata.update({
            "repair_patch_draft_status": str(data.get("status") or ""),
            "repair_patch_draft_draft_status": str(data.get("draft_status") or ""),
            "repair_patch_draft_has_patch": "true" if data.get("has_patch") else "false",
            "repair_patch_draft_target": target_label,
            "repair_patch_draft_next_need_kind": str(next_need.get("kind") or ""),
            "repair_patch_draft_next_need_query": compact(next_need.get("query") or "", 320),
            "repair_patch_draft_preview": compact(data.get("patch_preview") or data.get("proposal_preview") or "", 700),
        })
    if path and path.exists() and not metadata["repair_patch_draft_preview"]:
        metadata["repair_patch_draft_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_patch_draft_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_patch_draft_effectiveness": rel(path, root) if path else "",
        "repair_patch_draft_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_patch_draft_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_patch_draft_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_patch_draft_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_patch_draft_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_patch_draft_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_patch_draft_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_patch_draft_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_patch_draft_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_patch_draft_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_patch_draft_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_patch_draft_effectiveness_preview"]:
        metadata["repair_patch_draft_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata
...
def repair_patch_apply_metadata(root, value, json_value=""):
    ...
    if not json_path and path:
        ...
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_patch_apply": rel(path, root) if path else "",
        "repair_patch_apply_json": rel(json_path, root) if json_path else "",
        "repair_patch_apply_status": "",
        "repair_patch_apply_applied": "",
        "repair_patch_apply_authorized": "",
        "repair_patch_apply_target": "",
        "repair_patch_apply_patch_file": "",
        "repair_patch_apply_required_grant": "",
        "repair_patch_apply_grant_command": "",
        "repair_patch_apply_apply_command": "",
        "repair_patch_apply_summary": "",
        "repair_patch_apply_next_need_kind": "",
        "repair_patch_apply_next_need_query": "",
        "repair_patch_apply_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        target = data.get("target") if isinstance(data.get("target"), dict) else {}
        ...
        metadata.update({
            "repair_patch_apply_status": str(data.get("status") or ""),
            "repair_patch_apply_applied": "true" if data.get("applied") else "false",
            "repair_patch_apply_authorized": "true" if data.get("authorized") else "false",
            "repair_patch_apply_target": target_label,
            "repair_patch_apply_patch_file": str(data.get("patch_file") or ""),
            "repair_patch_apply_required_grant": str(data.get("required_grant") or ""),
            "repair_patch_apply_grant_command": str(data.get("grant_command") or ""),
            "repair_patch_apply_apply_command": str(data.get("apply_command") or ""),
            "repair_patch_apply_summary": compact(data.get("summary") or "", 360),
            "repair_patch_apply_next_need_kind": str(next_need.get("kind") or ""),
            "repair_patch_apply_next_need_query": compact(next_need.get("query") or "", 320),
            "repair_patch_apply_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_patch_apply_preview"]:
        metadata["repair_patch_apply_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_patch_verify_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_patch_verify": rel(path, root) if path else "",
        "repair_patch_verify_json": rel(json_path, root) if json_path else "",
        "repair_patch_verify_status": "",
        "repair_patch_verify_passed": "",
        "repair_patch_verify_target": "",
        "repair_patch_verify_command": "",
        "repair_patch_verify_summary": "",
        "repair_patch_verify_next_need_kind": "",
        "repair_patch_verify_next_need_query": "",
        "repair_patch_verify_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        target = data.get("target") if isinstance(data.get("target"), dict) else {}
        ...
        metadata.update({
            "repair_patch_verify_status": str(data.get("status") or ""),
            "repair_patch_verify_passed": "true" if data.get("passed") else "false",
            "repair_patch_verify_target": target_label,
            "repair_patch_verify_command": str(data.get("command") or ""),
            "repair_patch_verify_summary": compact(data.get("summary") or "", 360),
            "repair_patch_verify_next_need_kind": str(next_need.get("kind") or ""),
            "repair_patch_verify_next_need_query": compact(next_need.get("query") or "", 320),
            "repair_patch_verify_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_patch_verify_preview"]:
        metadata["repair_patch_verify_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_patch_verify_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_patch_verify_effectiveness": rel(path, root) if path else "",
        "repair_patch_verify_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_patch_verify_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_patch_verify_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_patch_verify_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_patch_verify_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_patch_verify_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_patch_verify_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_patch_verify_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_patch_verify_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_patch_verify_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_patch_verify_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_patch_verify_effectiveness_preview"]:
        metadata["repair_patch_verify_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_patch_learning_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_patch_learning": rel(path, root) if path else "",
        "repair_patch_learning_json": rel(json_path, root) if json_path else "",
        ...
        "repair_patch_learning_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        next_need = data.get("next_need") if isinstance(data.get("next_need"), dict) else {}
        metadata.update({
            "repair_patch_learning_status": str(data.get("status") or ""),
            "repair_patch_learning_used_count": str(data.get("used_count") or 0),
            "repair_patch_learning_verified_count": str(data.get("verified_count") or 0),
            "repair_patch_learning_verified_satisfied_count": str(data.get("verified_satisfied_count") or 0),
            "repair_patch_learning_verified_failed_count": str(data.get("verified_failed_count") or 0),
            "repair_patch_learning_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_patch_learning_verified_success_rate": str(data.get("verified_success_rate") or "0.00"),
            "repair_patch_learning_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_patch_learning_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_patch_learning_next_need_kind": str(next_need.get("kind") or ""),
            "repair_patch_learning_next_need_query": compact(next_need.get("query") or "", 320),
            "repair_patch_learning_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_patch_learning_preview"]:
        metadata["repair_patch_learning_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_patch_learning_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_patch_learning_effectiveness": rel(path, root) if path else "",
        "repair_patch_learning_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_patch_learning_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_patch_learning_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_patch_learning_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_patch_learning_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_patch_learning_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_patch_learning_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_patch_learning_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_patch_learning_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_patch_learning_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_patch_learning_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_patch_learning_effectiveness_preview"]:
        metadata["repair_patch_learning_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata
...
def repair_command_effectiveness_metadata(root, value, json_value=""):
    ...
    if not json_path and path:
        ...
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_command_effectiveness": rel(path, root) if path else "",
        "repair_command_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_command_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_command_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_command_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_command_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_command_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_command_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_command_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_command_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_command_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_command_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_command_effectiveness_preview"]:
        metadata["repair_command_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata
...
def repair_patch_strategy_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_patch_strategy": rel(path, root) if path else "",
        "repair_patch_strategy_json": rel(json_path, root) if json_path else "",
        ...
        "repair_patch_strategy_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        next_need = data.get("next_need") if isinstance(data.get("next_need"), dict) else {}
        metadata.update({
            "repair_patch_strategy_status": str(data.get("status") or ""),
            "repair_patch_strategy_focus": compact(data.get("focus") or "", 320),
            "repair_patch_strategy_learned_reuse": compact(data.get("learned_reuse") or "", 320),
            "repair_patch_strategy_learned_avoid": compact(data.get("learned_avoid") or "", 320),
            "repair_patch_strategy_next_need_kind": str(next_need.get("kind") or ""),
            "repair_patch_strategy_next_need_query": compact(next_need.get("query") or "", 320),
            "repair_patch_strategy_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_patch_strategy_preview"]:
        metadata["repair_patch_strategy_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_patch_strategy_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_patch_strategy_effectiveness": rel(path, root) if path else "",
        "repair_patch_strategy_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_patch_strategy_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_patch_strategy_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_patch_strategy_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_patch_strategy_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_patch_strategy_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_patch_strategy_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_patch_strategy_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_patch_strategy_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_patch_strategy_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_patch_strategy_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_patch_strategy_effectiveness_preview"]:
        metadata["repair_patch_strategy_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_command_strategy_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_command_strategy_effectiveness": rel(path, root) if path else "",
        "repair_command_strategy_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_command_strategy_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_command_strategy_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_command_strategy_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_command_strategy_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_command_strategy_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_command_strategy_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_command_strategy_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_command_strategy_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_command_strategy_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_command_strategy_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_command_strategy_effectiveness_preview"]:
        metadata["repair_command_strategy_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_decision_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_decision_effectiveness": rel(path, root) if path else "",
        "repair_decision_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_decision_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_decision_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_decision_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_decision_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_decision_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_decision_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_decision_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_decision_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_decision_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_decision_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_decision_effectiveness_preview"]:
        metadata["repair_decision_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata
...
def action_trace_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "action_trace_effectiveness": rel(path, root) if path else "",
        "action_trace_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "action_trace_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "action_trace_effectiveness_used_count": str(data.get("used_count") or 0),
            "action_trace_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "action_trace_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "action_trace_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "action_trace_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "action_trace_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "action_trace_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "action_trace_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "action_trace_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["action_trace_effectiveness_preview"]:
        metadata["action_trace_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata
...
def repair_effectiveness_rollup_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_effectiveness_rollup_effectiveness": rel(path, root) if path else "",
        "repair_effectiveness_rollup_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_effectiveness_rollup_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_effectiveness_rollup_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_effectiveness_rollup_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_effectiveness_rollup_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_effectiveness_rollup_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_effectiveness_rollup_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_effectiveness_rollup_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_effectiveness_rollup_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_effectiveness_rollup_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_effectiveness_rollup_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_effectiveness_rollup_effectiveness_preview"]:
        metadata["repair_effectiveness_rollup_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_effectiveness_rollup_adaptation_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_effectiveness_rollup_adaptation": rel(path, root) if path else "",
        "repair_effectiveness_rollup_adaptation_json": rel(json_path, root) if json_path else "",
        ...
        "repair_effectiveness_rollup_adaptation_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        next_need = data.get("next_need") if isinstance(data.get("next_need"), dict) else {}
        metadata.update({
            "repair_effectiveness_rollup_adaptation_status": str(data.get("status") or ""),
            "repair_effectiveness_rollup_adaptation_focus": compact(data.get("focus") or "", 320),
            "repair_effectiveness_rollup_adaptation_rollup_status": str(data.get("rollup_status") or ""),
            "repair_effectiveness_rollup_adaptation_guidance_used_count": str(data.get("guidance_used_count") or 0),
            "repair_effectiveness_rollup_adaptation_guidance_satisfied_count": str(data.get("guidance_satisfied_count") or 0),
            "repair_effectiveness_rollup_adaptation_guidance_partial_count": str(data.get("guidance_partial_count") or 0),
            "repair_effectiveness_rollup_adaptation_guidance_failed_count": str(data.get("guidance_failed_count") or 0),
            "repair_effectiveness_rollup_adaptation_guidance_success_rate": str(data.get("guidance_success_rate") or "0.00"),
            "repair_effectiveness_rollup_adaptation_guidance_failure_rate": str(data.get("guidance_failure_rate") or "0.00"),
            "repair_effectiveness_rollup_adaptation_next_need_kind": str(next_need.get("kind") or ""),
            "repair_effectiveness_rollup_adaptation_next_need_query": compact(next_need.get("query") or "", 320),
            "repair_effectiveness_rollup_adaptation_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_effectiveness_rollup_adaptation_preview"]:
        metadata["repair_effectiveness_rollup_adaptation_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata


def repair_queue_brief_effectiveness_metadata(root, value, json_value=""):
    path = resolve_artifact(root, value)
    json_path = resolve_artifact(root, json_value)
    if not json_path and path:
        candidate = path.with_suffix(".json")
        if candidate.exists():
            json_path = candidate
    metadata = {
        "repair_queue_brief_effectiveness": rel(path, root) if path else "",
        "repair_queue_brief_effectiveness_json": rel(json_path, root) if json_path else "",
        ...
        "repair_queue_brief_effectiveness_preview": "",
    }
    if json_path and json_path.exists():
        data = load_json(json_path)
        metadata.update({
            "repair_queue_brief_effectiveness_used_count": str(data.get("used_count") or 0),
            "repair_queue_brief_effectiveness_satisfied_count": str(data.get("satisfied_count") or 0),
            "repair_queue_brief_effectiveness_partial_count": str(data.get("partial_count") or 0),
            "repair_queue_brief_effectiveness_failed_count": str(data.get("failed_count") or 0),
            "repair_queue_brief_effectiveness_success_rate": str(data.get("success_rate") or "0.00"),
            "repair_queue_brief_effectiveness_failure_rate": str(data.get("failure_rate") or "0.00"),
            "repair_queue_brief_effectiveness_top_reuse": compact(data.get("top_reuse") or "", 320),
            "repair_queue_brief_effectiveness_top_avoid": compact(data.get("top_avoid") or "", 320),
            "repair_queue_brief_effectiveness_preview": compact(json.dumps(data, sort_keys=True), 700),
        })
    if path and path.exists() and not metadata["repair_queue_brief_effectiveness_preview"]:
        metadata["repair_queue_brief_effectiveness_preview"] = compact(path.read_text(encoding="utf-8", errors="replace"), 700)
    return metadata
...
if latest_repair_plan:
    ...
    action_trace_effectiveness = str(inputs.get("action_trace_effectiveness") or "")
    action_trace_effectiveness_json = str(inputs.get("action_trace_effectiveness_json") or "")
    ...
    repair_draft_strategy = str(inputs.get("repair_draft_strategy") or "")
    repair_draft_strategy_json = str(inputs.get("repair_draft_strategy_json") or "")
    repair_draft_strategy_effectiveness = str(inputs.get("repair_draft_strategy_effectiveness") or "")
    repair_draft_strategy_effectiveness_json = str(inputs.get("repair_draft_strategy_effectiveness_json") or "")
    repair_patch_draft = str(inputs.get("repair_patch_draft") or "")
    ...
    repair_patch_verify_effectiveness = str(inputs.get("repair_patch_verify_effectiveness") or "")
    repair_patch_verify_effectiveness_json = str(inputs.get("repair_patch_verify_effectiveness_json") or "")
    repair_patch_learning = str(inputs.get("repair_patch_learning") or "")
    repair_patch_learning_json = str(inputs.get("repair_patch_learning_json") or "")
    repair_patch_learning_effectiveness = str(inputs.get("repair_patch_learning_effectiveness") or "")
    repair_patch_learning_effectiveness_json = str(inputs.get("repair_patch_learning_effectiveness_json") or "")
    repair_patch_strategy = str(inputs.get("repair_patch_strategy") or "")
    repair_patch_strategy_json = str(inputs.get("repair_patch_strategy_json") or "")
    repair_patch_strategy_effectiveness = str(inputs.get("repair_patch_strategy_effectiveness") or "")
    repair_patch_strategy_effectiveness_json = str(inputs.get("repair_patch_strategy_effectiveness_json") or "")
    ...
    repair_command_strategy_effectiveness = str(inputs.get("repair_command_strategy_effectiveness") or "")
    repair_command_strategy_effectiveness_json = str(inputs.get("repair_command_strategy_effectiveness_json") or "")
    repair_decision_effectiveness = str(inputs.get("repair_decision_effectiveness") or "")
    repair_decision_effectiveness_json = str(inputs.get("repair_decision_effectiveness_json") or "")
    ...
    repair_effectiveness_rollup_effectiveness = str(inputs.get("repair_effectiveness_rollup_effectiveness") or "")
    repair_effectiveness_rollup_effectiveness_json = str(inputs.get("repair_effectiveness_rollup_effectiveness_json") or "")
    repair_effectiveness_rollup_adaptation = str(inputs.get("repair_effectiveness_rollup_adaptation") or "")
    ...
    action_effectiveness_metadata = action_trace_effectiveness_metadata(
        root,
    ...
    draft_strategy_metadata = repair_draft_strategy_metadata(
        root,
        repair_draft_strategy,
        repair_draft_strategy_json,
    )
    draft_strategy_effectiveness_metadata = repair_draft_strategy_effectiveness_metadata(
        root,
        repair_draft_strategy_effectiveness,
        repair_draft_strategy_effectiveness_json,
    )
    patch_draft_metadata = repair_patch_draft_metadata(
        root,
        repair_patch_draft,
        repair_patch_draft_json,
    )
    patch_draft_effectiveness_metadata = repair_patch_draft_effectiveness_metadata(
        root,
    ...
    patch_apply_metadata = repair_patch_apply_metadata(
        root,
        repair_patch_apply,
    ...
    patch_verify_effectiveness_metadata = repair_patch_verify_effectiveness_metadata(
        root,
        repair_patch_verify_effectiveness,
        repair_patch_verify_effectiveness_json,
    )
    patch_learning_metadata = repair_patch_learning_metadata(
        root,
        repair_patch_learning,
        repair_patch_learning_json,
    )
    patch_learning_effectiveness_metadata = repair_patch_learning_effectiveness_metadata(
        root,
        repair_patch_learning_effectiveness,
        repair_patch_learning_effectiveness_json,
    )
    patch_strategy_metadata = repair_patch_strategy_metadata(
        root,
        repair_patch_strategy,
        repair_patch_strategy_json,
    )
    patch_strategy_effectiveness_metadata = repair_patch_strategy_effectiveness_metadata(
        root,
    ...
    command_strategy_effectiveness_metadata = repair_command_strategy_effectiveness_metadata(
        root,
        repair_command_strategy_effectiveness,
        repair_command_strategy_effectiveness_json,
    )
    decision_effectiveness_metadata = repair_decision_effectiveness_metadata(
        root,
    ...
    rollup_effectiveness_metadata = repair_effectiveness_rollup_effectiveness_metadata(
        root,
        repair_effectiveness_rollup_effectiveness,
        repair_effectiveness_rollup_effectiveness_json,
    )
    rollup_adaptation_metadata = repair_effectiveness_rollup_adaptation_metadata(
        root,
        repair_effectiveness_rollup_adaptation,
        repair_effectiveness_rollup_adaptation_json,
    )
    queue_brief_effectiveness_metadata = repair_queue_brief_effectiveness_metadata(
        root,
    ...
    action_trace_effectiveness_used = action_effectiveness_metadata.get("action_trace_effectiveness_used_count", "")
    action_trace_effectiveness_success = action_effectiveness_metadata.get("action_trace_effectiveness_success_rate", "")
    ...
    draft_strategy_status = draft_strategy_metadata.get("repair_draft_strategy_status", "")
    draft_strategy_focus = draft_strategy_metadata.get("repair_draft_strategy_focus", "")
    draft_strategy_next_kind = draft_strategy_metadata.get("repair_draft_strategy_next_need_kind", "")
    draft_strategy_next_query = draft_strategy_metadata.get("repair_draft_strategy_next_need_query", "")
    draft_strategy_effectiveness_used = draft_strategy_effectiveness_metadata.get("repair_draft_strategy_effectiveness_used_count", "")
    draft_strategy_effectiveness_success = draft_strategy_effectiveness_metadata.get("repair_draft_strategy_effectiveness_success_rate", "")
    patch_draft_status = patch_draft_metadata.get("repair_patch_draft_status", "")
    ...
    patch_verify_effectiveness_used = patch_verify_effectiveness_metadata.get("repair_patch_verify_effectiveness_used_count", "")
    patch_verify_effectiveness_success = patch_verify_effectiveness_metadata.get("repair_patch_verify_effectiveness_success_rate", "")
    patch_learning_status = patch_learning_metadata.get("repair_patch_learning_status", "")
    patch_learning_used = patch_learning_metadata.get("repair_patch_learning_used_count", "")
    patch_learning_verified = patch_learning_metadata.get("repair_patch_learning_verified_count", "")
    patch_learning_verified_success = patch_learning_metadata.get("repair_patch_learning_verified_success_rate", "")
    patch_learning_next_kind = patch_learning_metadata.get("repair_patch_learning_next_need_kind", "")
    patch_learning_next_query = patch_learning_metadata.get("repair_patch_learning_next_need_query", "")
    patch_learning_effectiveness_used = patch_learning_effectiveness_metadata.get("repair_patch_learning_effectiveness_used_count", "")
    patch_learning_effectiveness_success = patch_learning_effectiveness_metadata.get("repair_patch_learning_effectiveness_success_rate", "")
    patch_strategy_status = patch_strategy_metadata.get("repair_patch_strategy_status", "")
    patch_strategy_focus = patch_strategy_metadata.get("repair_patch_strategy_focus", "")
    patch_strategy_next_kind = patch_strategy_metadata.get("repair_patch_strategy_next_need_kind", "")
    patch_strategy_next_query = patch_strategy_metadata.get("repair_patch_strategy_next_need_query", "")
    patch_strategy_effectiveness_used = patch_strategy_effectiveness_metadata.get("repair_patch_strategy_effectiveness_used_count", "")
    patch_strategy_effectiveness_success = patch_strategy_effectiveness_metadata.get("repair_patch_strategy_effectiveness_success_rate", "")
    ...
    command_strategy_effectiveness_used = command_strategy_effectiveness_metadata.get("repair_command_strategy_effectiveness_used_count", "")
    command_strategy_effectiveness_success = command_strategy_effectiveness_metadata.get("repair_command_strategy_effectiveness_success_rate", "")
    decision_effectiveness_used = decision_effectiveness_metadata.get("repair_decision_effectiveness_used_count", "")
    decision_effectiveness_success = decision_effectiveness_metadata.get("repair_decision_effectiveness_success_rate", "")
    ...
    rollup_effectiveness_used = rollup_effectiveness_metadata.get("repair_effectiveness_rollup_effectiveness_used_count", "")
    rollup_effectiveness_success = rollup_effectiveness_metadata.get("repair_effectiveness_rollup_effectiveness_success_rate", "")
    rollup_adaptation_status = rollup_adaptation_metadata.get("repair_effectiveness_rollup_adaptation_status", "")
    rollup_adaptation_focus = rollup_adaptation_metadata.get("repair_effectiveness_rollup_adaptation_focus", "")
    rollup_adaptation_used = rollup_adaptation_metadata.get("repair_effectiveness_rollup_adaptation_guidance_used_count", "")
    rollup_adaptation_failed = rollup_adaptation_metadata.get("repair_effectiveness_rollup_adaptation_guidance_failed_count", "")
    rollup_adaptation_success = rollup_adaptation_metadata.get("repair_effectiveness_rollup_adaptation_guidance_success_rate", "")
    rollup_adaptation_next_kind = rollup_adaptation_metadata.get("repair_effectiveness_rollup_adaptation_next_need_kind", "")
    rollup_adaptation_next_query = rollup_adaptation_metadata.get("repair_effectiveness_rollup_adaptation_next_need_query", "")
    ...
    elif rollup_next_query and rollup_status == "inspect_unreliable_sources":
    ...
    elif patch_strategy_next_query and patch_strategy_status != "collect_patch_outcomes":
        next_need_kind = patch_strategy_next_kind or "verify"
        next_need_query = patch_strategy_next_query
        next_need_source = "repair_patch_strategy"
    elif patch_learning_next_query and patch_learning_status != "collect_verified_patch_outcomes":
        next_need_kind = patch_learning_next_kind or "remember"
        next_need_query = patch_learning_next_query
        next_need_source = "repair_patch_learning"
    elif draft_strategy_next_query and draft_strategy_status != "collect_provider_draft_outcomes":
        next_need_kind = draft_strategy_next_kind or "verify"
        next_need_query = draft_strategy_next_query
        next_need_source = "repair_draft_strategy"
    ...
    patch_apply_applied_status = (
        not has_outcome
        and patch_apply_applied == "true"
    )
    patch_apply_failed = (
        not has_outcome
        and patch_apply_status in {"failed", "check_failed", "failed_to_start"}
    )
    patch_verify_passed_status = (
        patch_apply_applied_status
        and patch_verify_status == "passed"
        and patch_verify_passed == "true"
    )
    patch_verify_failed = (
        patch_apply_applied_status
        and patch_verify_status in {"failed", "failed_to_start"}
    )
    patch_apply_needs_verify = (
        patch_apply_applied_status
        and not patch_verify_passed_status
        and not patch_verify_failed
    )
    if has_outcome:
        ...
        checks = []
        suggested = []
    elif patch_verify_passed_status:
        plan_status = "patch_verified"
        status = "satisfied"
        next_need = "score verified repair patch"
        next_need_kind = "verify"
        next_need_query = "score the verified repair patch outcome"
        next_need_source = "repair_patch_verify"
        output = (
            f"heartbeat repair: repair_plan={rel(latest_repair_plan, root)}; "
            f"patch_verify={patch_verify_status}; passed={patch_verify_passed}; "
            f"target={target_tentacle}/{target_tool}; next={next_need_kind} {next_need_query}"
        )
        checks = []
        suggested = []
    elif patch_verify_failed:
        plan_status = "patch_verify_failed"
        status = "partial"
        blocker = patch_verify_summary or patch_verify_status or "repair patch verification failed"
        next_need = f"repair patch verification failure: {blocker}"
        next_need_kind = patch_verify_metadata.get("repair_patch_verify_next_need_kind") or "execute"
        next_need_query = patch_verify_metadata.get("repair_patch_verify_next_need_query") or "repair failed post-apply verification"
        next_need_source = "repair_patch_verify"
        output = (
            f"heartbeat repair: repair_plan={rel(latest_repair_plan, root)}; "
            f"patch_verify={patch_verify_status}; passed={patch_verify_passed or 'false'}; "
            f"target={target_tentacle}/{target_tool}; next={next_need_kind} {next_need_query}"
        )
        checks = []
        suggested = []
    elif patch_apply_applied_status:
        plan_status = "patch_applied"
        status = "satisfied"
        next_need = "verify applied repair patch"
        next_need_kind = "verify"
        next_need_query = "run post-apply repair patch verification"
        next_need_source = "repair_patch_apply"
        output = (
            f"heartbeat repair: repair_plan={rel(latest_repair_plan, root)}; "
            f"patch_apply={patch_apply_status}; applied={patch_apply_applied}; "
            f"patch_verify={patch_verify_status or 'none'}; "
            f"target={target_tentacle}/{target_tool}; next={next_need_kind} {next_need_query}"
        )
        checks = []
        suggested = [f"octopus repair verify {root}"]
    elif patch_apply_failed:
        plan_status = "patch_apply_failed"
        status = "partial"
        blocker = patch_apply_summary or patch_apply_status or "repair patch apply failed"
        next_need = f"repair patch apply failure: {blocker}"
        next_need_kind = patch_apply_metadata.get("repair_patch_apply_next_need_kind") or "execute"
        next_need_query = patch_apply_metadata.get("repair_patch_apply_next_need_query") or "repair failed repair patch apply"
        next_need_source = "repair_patch_apply"
        output = (
            f"heartbeat repair: repair_plan={rel(latest_repair_plan, root)}; "
            f"patch_apply={patch_apply_status}; applied={patch_apply_applied or 'false'}; "
            f"target={target_tentacle}/{target_tool}; next={next_need_kind} {next_need_query}"
        )
        checks = []
        suggested = []
        ...
        output = (
            ...
            f"action_trace_effectiveness={action_trace_effectiveness_used or '0'} success_rate={action_trace_effectiveness_success or '0.00'}; "
            f"draft_effectiveness={draft_effectiveness_used or '0'} success_rate={draft_effectiveness_success or '0.00'}; "
            f"draft_strategy={draft_strategy_status or 'none'} focus={draft_strategy_focus or 'none'}; "
            f"draft_strategy_effectiveness={draft_strategy_effectiveness_used or '0'} success_rate={draft_strategy_effectiveness_success or '0.00'}; "
            ...
            f"patch_verify_effectiveness={patch_verify_effectiveness_used or '0'} success_rate={patch_verify_effectiveness_success or '0.00'}; "
            ...
            f"patch_strategy={patch_strategy_status or 'none'} focus={patch_strategy_focus or 'none'}; "
            f"patch_strategy_effectiveness={patch_strategy_effectiveness_used or '0'} success_rate={patch_strategy_effectiveness_success or '0.00'}; "
            ...
            f"decision_effectiveness={decision_effectiveness_used or '0'} success_rate={decision_effectiveness_success or '0.00'}; "
    ...
    repair_metadata = {
        ...
        "action_trace_effectiveness": action_trace_effectiveness,
        "action_trace_effectiveness_json": action_trace_effectiveness_json,
        "repair_draft_effectiveness": repair_draft_effectiveness,
        "repair_draft_effectiveness_json": repair_draft_effectiveness_json,
        "repair_draft_strategy": repair_draft_strategy,
        "repair_draft_strategy_json": repair_draft_strategy_json,
        "repair_draft_strategy_effectiveness": repair_draft_strategy_effectiveness,
        "repair_draft_strategy_effectiveness_json": repair_draft_strategy_effectiveness_json,
        "repair_patch_draft": repair_patch_draft,
        ...
        "repair_patch_verify_effectiveness": repair_patch_verify_effectiveness,
        "repair_patch_verify_effectiveness_json": repair_patch_verify_effectiveness_json,
        "repair_patch_learning": repair_patch_learning,
        "repair_patch_learning_json": repair_patch_learning_json,
        "repair_patch_learning_effectiveness": repair_patch_learning_effectiveness,
        "repair_patch_learning_effectiveness_json": repair_patch_learning_effectiveness_json,
        "repair_patch_strategy": repair_patch_strategy,
        "repair_patch_strategy_json": repair_patch_strategy_json,
        "repair_patch_strategy_effectiveness": repair_patch_strategy_effectiveness,
        "repair_patch_strategy_effectiveness_json": repair_patch_strategy_effectiveness_json,
        ...
        "repair_command_strategy_effectiveness": repair_command_strategy_effectiveness,
        "repair_command_strategy_effectiveness_json": repair_command_strategy_effectiveness_json,
        "repair_decision_effectiveness": repair_decision_effectiveness,
        "repair_decision_effectiveness_json": repair_decision_effectiveness_json,
        "repair_decision": repair_decision,
        ...
        "repair_effectiveness_rollup_effectiveness": repair_effectiveness_rollup_effectiveness,
        "repair_effectiveness_rollup_effectiveness_json": repair_effectiveness_rollup_effectiveness_json,
        "repair_effectiveness_rollup_adaptation": repair_effectiveness_rollup_adaptation,
        ...
        "patch_apply_blocker": patch_apply_status if patch_apply_failed else "",
        "patch_verify_blocker": patch_verify_status if patch_verify_failed else "",
        "grant_command": "" if has_outcome or adapter_blocked or draft_blocked or action_trace_blocked or patch_review_blocked or patch_apply_applied_status or patch_apply_failed else command_value(commands, "grant"),
        "apply_command": "" if has_outcome or adapter_blocked or draft_blocked or action_trace_blocked or patch_review_blocked or patch_apply_applied_status or patch_apply_failed else command_value(commands, "apply"),
        "score_command": "" if has_outcome or adapter_blocked or draft_blocked or action_trace_blocked or patch_review_blocked or patch_apply_needs_verify else command_value(commands, "score"),
        "score_commands": "" if has_outcome or adapter_blocked or draft_blocked or action_trace_blocked or patch_review_blocked or patch_apply_needs_verify else command_lines(commands, "score_options"),
    ...
    repair_metadata.update(action_effectiveness_metadata)
    repair_metadata.update(draft_effectiveness_metadata)
    repair_metadata.update(draft_strategy_metadata)
    repair_metadata.update(draft_strategy_effectiveness_metadata)
    ...
    repair_metadata.update(patch_verify_effectiveness_metadata)
    repair_metadata.update(patch_learning_metadata)
    repair_metadata.update(patch_learning_effectiveness_metadata)
    repair_metadata.update(patch_strategy_metadata)
    repair_metadata.update(patch_strategy_effectiveness_metadata)
    ...
    repair_metadata.update(decision_effectiveness_metadata)
