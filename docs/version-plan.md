...
Last cleanup/version correction: `0.0.12` on 2026-06-27. Scope: bridge startup, pixel pet SVG export, clean-brain clarification, reflection, memory, council, synthesis, provider slots, native app controls, README/version consistency, and cleanup scan; no tag cut.
