...
Last cleanup/version correction: `0.0.6` on 2026-06-26. Scope: clean-brain context inspection, Feed trace feedback scoring, feed-driven harness beat evolution, app apply controls, docs/CI alignment; no tag cut.
