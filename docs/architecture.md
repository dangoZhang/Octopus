...
`starter [objective]` reads profile and manifest metadata, then recommends grouped starter tentacles, install commands, checks, and the first Need command for that objective without installing or executing tools.
