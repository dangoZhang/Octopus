...
- The HTML app can run, stream, inspect tentacle thinking, show Feed traces, guide tentacle install/grants, show install check status, and expose check output through a local bridge; richer desktop UX still needs work.
...
- Add single-check rerun and real-machine check history to the guided HTML install flow.
