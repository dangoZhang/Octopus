...
- LLM adapters support OpenAI-compatible providers for chat goal refinement, clean-brain Goal/Intent/Brief/Clarify/Agenda/Deliberate/Council/Synthesize/Explore/Rewrite/Queue/Memory jobs, manifest tool planning, and harness evolution candidate generation.
...
- `provider status` reports chat, clean-brain model slots including intent, brief, clarification, agenda, memory, and synthesis, tentacle-planning, and harness-evolution LLM readiness without a network call.
...
- Clean-brain Goal, intent, brief, clarification, agenda, memory, reflection, and exploration reports now include a Need audit that flags tool/API/command/file burden and exposes only clean Needs for follow-up commands or queueing.
...
- The native HTML app can run Intent Session, Intent, Save Intent, Brief Session, Brief, Save Brief, Clarify Session, Clarify, Apply Clarify, Agenda Session, Agenda, and Apply Agenda controls so questions and cognitive priorities can be drafted or imported without Feed execution.
