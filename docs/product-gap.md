...
- Run the final GitHub-installed binary gate from the new remote head, then tag `0.1.0` only if installed startup, app, provider, benchmark, PR dry-run, and live preflight stay green.
