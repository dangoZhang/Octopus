...
Updated: 2026-07-01, after field-pack dry-run validation plus math-mini-7 and write-mini-7 self-evolution.
...
| Editable tentacles | Code-as-harness Feed suppliers: prompts, manifests, tools, declared evolution requirements, field-pack task targets, repair templates, repair surfaces | `tentacles/**` | 22,700 |
...
- Latest self-evolution proof point: math-mini-7 and write-mini-7 were generated by `evolve drive`, passed `planning -> recommended -> applied -> checking -> need -> feed`, refreshed the native desktop pet, and produced Feed traces #138/#139 plus verifiers #118/#119 with artifact evidence under `.octopus/field-mini-task/`.
...
| Area | Files | Lines |
| --- | ---: | ---: |
| `crates/octopus-core/src` | 58 | 61,705 |
| `crates/octopus-core/examples` | 0 | 0 |
| `tentacles` | 104 | 22,700 |
| `field-packs` | 14 | 743 |
| `desktop/pet` | 1 | 841 |
