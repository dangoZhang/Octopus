...
pub(crate) fn report(state_path: &Path) -> CoreBoundaryReport {
    ...
    let stable_rust = vec![
        ...
        path_report(
            root.join("crates/octopus-core/src/brain_goal_surface.rs"),
            "brain-goal-surface",
        ),
        path_report(
        ...
        path_report(
            root.join("crates/octopus-core/src/evolution_surface.rs"),
            "evolution-command-surface",
        ),
        path_report(
            root.join("crates/octopus-core/src/feedback_surface.rs"),
            "feedback-command-surface",
        ),
        path_report(
            root.join("crates/octopus-core/src/field_surface.rs"),
            "field-adaptation-command-surface",
        ),
        path_report(
            root.join("crates/octopus-core/src/heartbeat_surface.rs"),
        ...
        path_report(
            root.join("crates/octopus-core/src/preflight_surface.rs"),
            "preflight-surface",
        ),
        path_report(
