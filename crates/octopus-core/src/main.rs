...
"#,
    ...
    fn cli_catalog_and_env_commands_run() {
        ...
        assert!(usage().contains(
            "brain [--goal] [--live] [--save] [--session] [--rewrite] [--deliberate] [--synthesize] [--council] [--reflect] [--apply path|-] [--apply-json json] [prompt]"
        ));
