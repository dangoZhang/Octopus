...
use octopus_core::{
    ...
    OpenAiCompatibleTuning, ParallelEvolutionRun, RepairOutcome, RouteReport, SelfIterationPlan,
...
use llm_layers::*;
use need_runner::{
    empty_parallel_evolution_batch_report, parallel_evolution_next_actions, parse_need_run_request,
    ...
    run_queued_need_with_observer_state, run_queued_needs_with_observer_state, NeedRunBatchReport,
    NeedRunReport, NeedRunRequest,
};
#[cfg(test)]
