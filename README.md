...
- clean-brain chat, goal refinement, pasteable brain prompts, and Need exploration
...
Then visit `http://127.0.0.1:8765/app.html` for bootstrap, provider setup, brain prompts, exploration, context, traces, checks, grants, and the pixel pet.
